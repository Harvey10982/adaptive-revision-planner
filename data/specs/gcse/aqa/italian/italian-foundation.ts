  ...
  units: [
    {
      ...
      topics: [
        ...
        {
          id: "topic-theme-1-4-customs-and-festivals-in-italian-speaking-countries-communities",
          name: "Customs and festivals in Italian-speaking countries/communities",
          subTopics: [
            { id: "topic-theme-1-4-customs-and-festivals-in-italian-speaking-countries-communities-all", name: "All content within this topic (see specification)" }
          ]
        }
      ]
    },
