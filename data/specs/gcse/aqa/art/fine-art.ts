    ...
    // =====================================================
    {
      ...
      topics: [
        ...
        },
        {
          ...
          name: "Technical Skills (Art and Design (Fine art))",
          subTopics: [
                { id: "sub-tech-drawing-observational-and-expressive", name: "Drawing (observational and expressive)" },
                { id: "sub-tech-painting-media-handling-and-colour-theory", name: "Painting (media handling and colour theory)" },
                { id: "sub-tech-printmaking-relief-mono-screen-as-appropriate", name: "Printmaking (relief, mono, screen – as appropriate)" },
                { id: "sub-tech-sculpture-3d-fine-art-approaches", name: "Sculpture / 3D fine art approaches" },
                { id: "sub-tech-mixed-media-and-experimental-processes", name: "Mixed media and experimental processes" },
                { id: "sub-tech-life-drawing-figure-studies-where-appropriate", name: "Life drawing / figure studies (where appropriate)" }
          ]
        }
      ]
    },
