    ...
    // =====================================================
    {
      ...
      topics: [
        ...
        },
        {
          ...
          name: "Technical Skills (Art and Design (Textile design))",
          subTopics: [
                { id: "sub-tech-pattern-design-repeat-placement-motif-development", name: "Pattern design (repeat, placement, motif development)" },
                { id: "sub-tech-fabric-manipulation-pleating-applique-quilting", name: "Fabric manipulation (pleating, applique, quilting)" },
                { id: "sub-tech-dyeing-and-colour-on-fabric", name: "Dyeing and colour on fabric" },
                { id: "sub-tech-printing-block-screen-heat-transfer-as-appropriate", name: "Printing (block, screen, heat transfer – as appropriate)" },
                { id: "sub-tech-stitch-embroidery-techniques", name: "Stitch / embroidery techniques" },
                { id: "sub-tech-construction-and-sampling-materials-texture-finishes", name: "Construction and sampling (materials, texture, finishes)" }
          ]
        }
      ]
    },
