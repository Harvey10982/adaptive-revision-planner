# Generate fully expanded AQA GCSE Combined Science: Trilogy (8464) specification
# Using innerSubjects -> units -> topics -> subTopics. Includes Biology, Chemistry, Physics in full depth
# based on the user's pasted Save My Exams outline.

file_path = "/mnt/data/aqa_gcse_combined_science_trilogy_FOUNDATION_FULL_DETAILED.ts"

ts = """import { SubjectSpecification } from "@/types/SubjectSpecification";
