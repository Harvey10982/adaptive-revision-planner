// data/specs/gcse/aqa/religious-studies-b/foundation.ts
...
export const specification: SubjectSpecification = {
  units: [
    {
      ...
      topics: [
        {
          id: "topic-catholic-christianity-and-creation",
          name: "Catholic Christianity & Creation",
          subTopics: [
            { id: "subtopic-art-expression", name: "Art as a Form of Expression in Catholic Christianity" },
            { id: "subtopic-nature-of-god", name: "The Nature of God" },
            { id: "subtopic-humanity-image-of-god", name: "Humanity in the Image of God" },
            { id: "subtopic-the-bible", name: "The Bible" },
            { id: "subtopic-bible-word-of-god", name: "The Bible as the Word of God" },
            { id: "subtopic-genesis-creation-accounts", name: "Genesis Creation Accounts" },
            { id: "subtopic-natural-law-science", name: "Natural Law & Catholic Attitudes Towards Science" },
            { id: "subtopic-practices-environment", name: "Catholic Practices & the Environment" }
          ]
        },
        {
          id: "topic-catholic-christianity-and-incarnation",
          name: "Catholic Christianity & Incarnation",
          subTopics: [
            { id: "subtopic-incarnation-beliefs-teachings", name: "Catholic Beliefs & Teachings about Incarnation" },
            { id: "subtopic-symbols-expression", name: "Symbols as a Form of Expression in Catholic Christianity" },
            { id: "subtopic-jesus-and-scripture", name: "Jesus & Scripture" },
            { id: "subtopic-irenaeus", name: "The Significance of Irenaeus' Writing" },
            { id: "subtopic-magisterium-incarnation", name: "Magisterium & Incarnation" },
            { id: "subtopic-practices-incarnation", name: "Catholic Practices & Incarnation" }
          ]
        }
      ]
    },

    {
      ...
      topics: [
        {
          id: "topic-islamic-key-beliefs-faith",
          name: "Islamic Key Beliefs: Faith",
          subTopics: [
        ...
        {
          id: "topic-islamic-key-beliefs-nature-of-allah",
          name: "Islamic Key Beliefs: The Nature of Allah",
          subTopics: [
        ...
        {
          id: "topic-islamic-key-beliefs-authority",
          name: "Islamic Key Beliefs: Authority",
          subTopics: [
        ...
        {
          id: "topic-islamic-key-practices-worship",
          name: "Islamic Key Practices: Worship",
          subTopics: [
            ...
            { id: "subtopic-salah", name: "Salah in Islam" }
          ]
        },
        {
          id: "topic-islamic-key-practices-duties-and-festivals",
          name: "Islamic Key Practices: Duties & Festivals",
          subTopics: [
            { id: "subtopic-sawm", name: "Sawm" },
            { id: "subtopic-zakah", name: "Zakah" },
            { id: "subtopic-hajj", name: "Hajj" },
            { id: "subtopic-jihad", name: "Jihad" },
            { id: "subtopic-id-ul-adha-id-ul-fitr", name: "Id-ul-Adha & Id-ul-Fitr" },
...

    {
      ...
      topics: [
        ...
        {
          id: "topic-judaism-key-beliefs-covenant-and-mitzvot",
          name: "Judaism Key Beliefs: The Covenant & the Mitzvot",
          subTopics: [
        ...
        },
        {
          ...
          subTopics: [
            ...
            { id: "subtopic-services", name: "Services at the Synagogue" },
            { id: "subtopic-worship-home-synagogue", name: "Worship in the Home & Synagogue" },
            { id: "subtopic-tenakh-talmud", name: "The Tenakh & the Talmud" }
          ]
        },
        {
    ...
    {
      id: "unit-religion-relationships-and-families",
      name: "Religion, Relationships & Families",
      topics: [
        {
          id: "topic-catholic-christianity-and-relationships",
          name: "Catholic Christianity & Relationships",
          subTopics: [
            { id: "subtopic-sexual-love", name: "Relationships: Sexual Love" },
            { id: "subtopic-marriage", name: "Relationships: Marriage" },
            { id: "subtopic-family", name: "Relationships: Family" },
            { id: "subtopic-equality", name: "Relationships: Equality" }
          ]
        }
      ]
    },
    ...
    {
      id: "unit-st-marks-gospel-spiritual-truth",
      name: "St Mark's Gospel as a Source of Spiritual Truth",
      topics: [
        {
        ...
        {
          id: "topic-relationship-with-marginalised",
          name: "Jesus' Relationship with People Disregarded By Society",
          subTopics: [
        ...
        },
        {
          ...
          subTopics: [
            ...
            { id: "subtopic-cost-reward", name: "The Cost & Reward of Discipleship" },
  ...
  papers: [
    {
      id: "paper-1",
      name: "Paper 1 (Catholic Christianity + St Mark’s Gospel)",
      assessedNodeIds: ["unit-catholic-christianity", "unit-st-marks-gospel-life-of-jesus", "unit-st-marks-gospel-spiritual-truth"]
    },
    {
      id: "paper-2",
      name: "Paper 2 (Islam + Judaism + Relationships & Families)",
      assessedNodeIds: ["unit-islam", "unit-judaism", "unit-religion-relationships-and-families"]
    }
  ]
};
