# FULL EXHAUSTIVE AQA GCSE MATHS HIGHER SPECIFICATION
# Includes every item from the provided list.
# Logical grouping applied, but no content omitted.

content = """import { SubjectSpecification } from "@/types/SubjectSpecification";
...
file_path = "/mnt/data/aqa_gcse_maths_higher_FULL_EXHAUSTIVE.ts"
